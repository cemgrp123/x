...
document.getElementById('submitBtn').addEventListener('click', async () => {
  ...
  try {
const response = await fetch('https://www.yemekhanegltp.com/api/auth/login', {
      method: 'POST',
      headers: {
...
window.location.href = `https://www.yemekhanegltp.com/profil.html?schoolNo=${data.schoolNo}`;
  } catch (error) {
